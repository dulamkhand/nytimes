...
//require_once('/public_html/girasole/sfapps/config/ProjectConfiguration.class.php');
$configuration = ProjectConfiguration::getApplicationConfiguration('admin', 'dev', true);
$user = sfContext::createInstance($configuration)->getUser();
...
$Config['UserFilesPath'] = '/girasole/uploads/files/';
...
$Config['AllowedExtensions']['Image']	= array('jpg','gif','jpeg','png','bmp','dot','dotx','doc','docx','xls','xlsx','csv','pdf','pdfx','xpdf','ppt','pptx','zip','rar','html','htm','txt') ;
