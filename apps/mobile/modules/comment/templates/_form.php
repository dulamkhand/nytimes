...
<form action="#" method="post" class="form" id="comment-form">
      ...
      <input type="text" name="comment-name" id="comment-name" value="Зочин" style="margin:0 0 2px 0;border:1px solid #ccc;width:98%;" /><br>
      <textarea name="comment-area" id="comment-area" style="margin:0 0 4px 0;border:1px solid #ccc;width:98%;height:150px;">Сайн байна уу, </textarea>
      ...
      <?php echo image_tag('loading.gif', array('id'=>'comment-loader', 'style'=>'display:none;'))?>
      <br clear="all">
</form>
