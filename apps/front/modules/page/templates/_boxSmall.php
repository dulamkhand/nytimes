...
<div class="left box" style="border-top:2px solid #0677cf;">
    ...
    <a href="<?php echo $url?>" title="<?php echo $rs->getTitle()?>">
        <?php echo image_tag($cover, array('style'=>'float:left;max-width:240px;margin:0 10px 0 0;'))?>
    </a>
    <div class="left" style="position:relative;width:500px;height:<?php echo $dim[1]?>px;">
        <?php echo mb_strlen($rs->getIntro()) > 250 ? utf8_substr(GlobalLib::clearOutput($rs->getIntro()), 0, 250).'..' : GlobalLib::clearOutput($rs->getIntro());?>
