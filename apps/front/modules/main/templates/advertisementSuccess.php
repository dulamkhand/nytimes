...
<?php if($page->getIntro()):?>
    <div style="background:#fff;width:720px;padding:15px;line-height:30px;border-top:2px solid #ff7f27;text-align:center;">
...
<br clear="all">
<div style="background:#fff;width:720px;padding:15px;line-height:30px;border-top:2px solid #ff7f27;">
