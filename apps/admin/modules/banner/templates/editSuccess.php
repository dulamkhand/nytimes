...
<?php endif; ?>
  <table>
    ...
    <tbody>
	  ...
	  <tr>
        <th><?php echo $form['mobile_img']->renderLabel() ?></th>
        <td>
          <?php echo $form['mobile_img']->renderError() ?>
          <?php echo $form['mobile_img'] ?>
          <div class="description"><?php echo $form['mobile_img']->renderHelp() ?></div>
        </td>
      </tr>
      <tr>
