...
class BannerForm extends BaseBannerForm
{
  public function configure()
  {
      ...
      $this->widgetSchema['mobile_img']  = new sfWidgetFormInputFile(array(), array());
      ...
      $this->validatorSchema['path']    = new sfValidatorFile(
                                                  array('required' => false,
                                                      ...
                                                      'max_size'   => 104857600,
                                                      //'mime_types' =>  array('image/jpeg','image/pjpeg','image/png','image/x-png','image/gif','application/x-shockwave-flash','application/octet-stream')
                                                      'mime_types' =>  null),
                                                  array(
                                                      'max_size'   => 'Файлын хэмжээ хамгийн ихдээ 10MB байна',
                                                      'mime_types' => 'Дараах өргөтгөлтэй файлууд зөвшөөрөгдөнө: jpg, png, gif and swf'));
	$this->validatorSchema['mobile_img']    = new sfValidatorFile(
                                                  array('required' => false,
                                                      'path'       => sfConfig::get("sf_upload_dir")."/b",
                                                      'max_size'   => 104857600,
	...
	# LABEL
    $this->widgetSchema->setLabel('path', 'File');
    $this->widgetSchema->setLabel('mobile_img', 'Flash үед гар утсан дээр харагдах зураг');
  }
