 ...
 * @property Doctrine_Collection $PollOptionVote
 * 
 ...
 * @method Doctrine_Collection getPollOptionVote() Returns the current record's "PollOptionVote" collection
 ...
 * @method PollOption          setImage()          Sets the current record's "image" value
 ...
 * @method PollOption          setPollOptionVote() Sets the current record's "PollOptionVote" collection
 * 
 * @package    imdb
 * @subpackage model
...
abstract class BasePollOption extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasMany('PollOptionVote', array(
             'local' => 'id',
             'foreign' => 'option_id'));
    }
}