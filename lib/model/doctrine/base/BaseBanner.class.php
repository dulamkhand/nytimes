 ...
 * @method string    getMobileImg()   Returns the current record's "mobile_img" value
 ...
 * @method Banner    setMobileImg()   Sets the current record's "mobile_img" value
...
abstract class BaseBanner extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('mobile_img', 'string', 100, array(
             'type' => 'string',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
